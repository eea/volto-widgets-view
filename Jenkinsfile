        ...
        node(label: 'swarm') {
          script{
            ...
            withSonarQubeEnv('Sonarqube') {
              sh '''sed -i "s#/opt/frontend/my-volto-project#$(pwd)#g" xunit-reports/coverage/lcov.info'''
              sh '''ls /var/jenkins_home/worker/workspace/addons_volto-widgets-view_master/src/config.js'''
              sh '''pwd; ls -ltr'''
